...
const Contact = () => {
    ...
    formData.append("access_key","6a9ffef4-3798-424f-9ba5-e85586eb479d");
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length: 90%_auto]'>
        ...
        className='text-center text-5xl font-Ovo'>
            ...
            className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I'd love to hear from you! If you have any questions, comments, feedback, please use the form below.</motion.p>
